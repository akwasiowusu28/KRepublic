package com.republic.ui.support.PostingStrategy;
...
public class AudioPoster implements Poster {
    ...
    @Override
    public void post(Context context, String fileName, AccessToken accessToken) {
        postAudioFileToSoundCloud(context, fileName, new OperationCallback() {
    ...
    private static void postAudioFileToSoundCloud(final Context context, final String audioFileName, final OperationCallback callback) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final String link = soundCloud.postTrack(new Track(audioFileName, audioFileName)).getStreamUrl();
