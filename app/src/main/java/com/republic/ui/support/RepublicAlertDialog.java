...
/**
 * A Custom RepublicAlertDialog for use in the whole Melanie app when an alert is needed
 *
 * @author Akwasi Owusu
 */
public class RepublicAlertDialog extends android.app.AlertDialog.Builder {
     ...
     *
     * @param context       The activity that creates this dialog
     * @param buttonsMode   One of the MelanieAlertDialogButtonsMode enumeration: YES_NO
     *                      and YES_NO_CANCEL
     * @param buttonMethods
     */
    public RepublicAlertDialog(Context context, ButtonModes buttonsMode, ButtonMethods buttonMethods) {
        super(context);
